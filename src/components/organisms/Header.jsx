  ...
  return (
    ...
    <div className="px-4 lg:px-8 py-4">
        <div className="flex items-center justify-between">
            ...
            {(isOnBoardsPage || isOnBoardDetailPage) && <Button
            ...
            {location.pathname === "/admin/boards" && <Button
                onClick={() => {
            ...
            <div className="relative">
                <Button
                    ...
                    className="p-2">
                    <div
                        className="w-8 h-8 bg-gradient-to-br from-primary-500 to-secondary-500 rounded-full flex items-center justify-center text-white text-sm font-medium">U
                                        </div>
                </Button>
            </div>
        </div>
